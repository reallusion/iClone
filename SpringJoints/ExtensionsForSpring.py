...
class SkeletonTreeViewControl(QtWidgets.QGroupBox):
    ...
    def __init__(self, parent=None):
        ...
        self._treeWidget.setHorizontalScrollBarPolicy(Qt.ScrollBarAsNeeded)
        self._treeWidget.header().setSectionResizeMode(QtWidgets.QHeaderView.ResizeToContents)
